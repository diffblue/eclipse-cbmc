...
/**
 * This is the item provider adapter for a {@link org.eclipse.cbmc.PropertyCategory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyCategoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyCategory_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyCategory_name_feature", "_UI_PropertyCategory_type"),
				 CbmcPackage.Literals.PROPERTY_CATEGORY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CbmcPackage.Literals.PROPERTY_CATEGORY__PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((PropertyCategory)object).getName();
