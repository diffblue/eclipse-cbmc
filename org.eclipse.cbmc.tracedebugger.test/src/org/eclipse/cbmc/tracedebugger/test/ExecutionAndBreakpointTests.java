...
public class ExecutionAndBreakpointTests {
	...
	public static Collection<String[]> data() {
       return Arrays.asList(new String[][] { {"stepIntoOnNonFunctions.txt"}, {"runToTheEnd.txt"}, { "stepOverAllTheWay.txt" },  {"stepIntoFunctionAndNextUntilTheEnd.txt"}, {"keepRunningAfterError.txt"}, {"stepInStepOut.txt"}, { "runToBreakpoint.txt" }, {"stackListFrames.txt"},{ "stepOutWhenBreakpointInTheWay.txt"} });
   }
