 ...
 * @generated
 */
public class FunctionCallImpl extends StepImpl implements FunctionCall {
	/**
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.FUNCTION_CALL;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.FUNCTION_CALL__ID, oldId, id));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.FUNCTION_CALL__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracePackage.FUNCTION_CALL__ID:
				return getId();
