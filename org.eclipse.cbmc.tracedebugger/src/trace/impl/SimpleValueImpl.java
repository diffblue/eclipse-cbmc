 ...
 * <ul>
 *   <li>{@link trace.impl.SimpleValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleValueImpl extends ValueImpl implements SimpleValue {
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.SIMPLE_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.SIMPLE_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracePackage.SIMPLE_VALUE__VALUE:
				return getValue();
		}
