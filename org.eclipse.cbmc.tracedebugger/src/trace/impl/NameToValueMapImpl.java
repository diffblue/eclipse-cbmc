...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Name To Value Map</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class NameToValueMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,Value> {
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.NAME_TO_VALUE_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.NAME_TO_VALUE_MAP__KEY, oldKey, key));
	}
