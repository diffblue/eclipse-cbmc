 ...
 * <ul>
 *   <li>{@link trace.impl.OutputImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutputImpl extends StepImpl implements Output {
	/**
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.OUTPUT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.OUTPUT__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracePackage.OUTPUT__TEXT:
				return getText();
		}
