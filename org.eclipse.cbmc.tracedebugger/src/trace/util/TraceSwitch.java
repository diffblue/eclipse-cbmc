...
public class TraceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TracePackage.ASSIGNMENT: {
				...
				if (result == null) result = caseStep(assignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TracePackage.FAILURE: {
				Failure failure = (Failure)theEObject;
				T result = caseFailure(failure);
				if (result == null) result = caseStep(failure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TracePackage.FUNCTION_CALL: {
				FunctionCall functionCall = (FunctionCall)theEObject;
				T result = caseFunctionCall(functionCall);
				if (result == null) result = caseStep(functionCall);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TracePackage.FUNCTION_RETURN: {
				FunctionReturn functionReturn = (FunctionReturn)theEObject;
				T result = caseFunctionReturn(functionReturn);
				if (result == null) result = caseStep(functionReturn);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TracePackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TracePackage.LOCATION_ONLY: {
				LocationOnly locationOnly = (LocationOnly)theEObject;
				T result = caseLocationOnly(locationOnly);
				if (result == null) result = caseStep(locationOnly);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TracePackage.OUTPUT: {
				Output output = (Output)theEObject;
				T result = caseOutput(output);
				if (result == null) result = caseStep(output);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Location Only</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Location Only</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLocationOnly(LocationOnly object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Union Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Union Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
