...
public class StringToBreakpointMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,Breakpoint> {
	 ...
	 * @generated
	 */
	public Breakpoint getTypedValue() {
	 ...
	 * @generated
	 */
	public Breakpoint basicGetTypedValue() {
		return value;
	}
	 ...
	 * @generated
	 */
	public void setTypedValue(Breakpoint newValue) {
	 ...
	 * @generated
	 */
	public Breakpoint setValue(Breakpoint value) {
		Breakpoint oldValue = getValue();
		setTypedValue(value);
		return oldValue;
	}
	...
	public EMap<String, Breakpoint> getEMap() {
